...
const CreateCase = React.lazy(() => import('../pages/dashboard/CreateCase'));

const Insurer = React.lazy(() => import('../pages/dashboard/Insurer'));
const InsuranceProvider = React.lazy(() => import('../pages/dashboard/InsuranceProvider'));
const ThirdPartyAdmins = React.lazy(() => import('../pages/dashboard/ThirdPartyAdmins'));
// apps
...
const A1form = React.lazy(() => import('../pages/other/A1form'));
...
const InsuranceProviderRoutes = {
    path: '/Provider',
    name: 'Provider',
    icon: FeatherIcon.LifeBuoy,

    component: InsuranceProvider,
    roles: ['Admin'],
    route: PrivateRoute,
};
const ThirdPartyAdminsRoutes = {
    path: '/ThirdPartyAdmins',
    name: 'Third Party Admins',
    icon: FeatherIcon.UserPlus,

    component: ThirdPartyAdmins,
    roles: ['Admin'],
    route: PrivateRoute,
};
...
const allRoutes = [
    ...
    ThirdPartyAdminsRoutes,
    authRoutes,
];

const authProtectedRoutes = [dashboardRoutes, InsurerRoutes, InsuranceProviderRoutes, ThirdPartyAdminsRoutes];
